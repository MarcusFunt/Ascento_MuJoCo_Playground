...
def test_launcher_extracts_runtime_device_seed_and_world_size():
    ...
    assert _runtime_status_from_line(
        ...
        "failed_windows=0 stage_windows=4 top_horizon_windows=3 control_steps=118000 "
        "transition=protected timeout_fraction=0.4219 "
        "candidate_checkpoint=model_best_long_horizon.pt"
    ) == {
